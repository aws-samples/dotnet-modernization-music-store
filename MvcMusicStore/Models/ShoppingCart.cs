    ...
    public partial class ShoppingCart
    {
        ...
        public void AddToCart(Album album)
        {
            ...
            if (cartItem == null)
            {
                ...
                cartItem = new Cart{AlbumTitle = album.Title, AlbumPrice = album.Price, RecordId = Guid.NewGuid(), AlbumId = album.AlbumId, CartId = ShoppingCartId, Count = 1, DateCreated = DateTime.Now};
        ...
        public Guid CreateOrder(Order order)
        {
            ...
            {
                var orderDetail = new OrderDetail{OrderDetailId = Guid.NewGuid(), AlbumId = item.AlbumId, OrderId = order.OrderId, UnitPrice = item.AlbumPrice, Quantity = item.Count};
